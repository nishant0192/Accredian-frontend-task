...
const Nav = () => {
  ...
  return (
    <div className="navbar bg-[#1A73E8] bg-opacity-10 rounded-[50px] mt-12" ref={navRef}>
      ...
      <a href="#" className={`nav-item ${activeIndex === 2 ? 'active text-[#1A73E8]' : 'text-[#4B4B4B]'}`} onClick={() => handleItemClick(2)}>FAQs</a>
      <a href="#" className={`nav-item ${activeIndex === 3 ? 'active text-[#1A73E8]' : 'text-[#4B4B4B]'}`} onClick={() => handleItemClick(3)}>Support</a>
